...
public class Maps extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMyLocationButtonClickListener, Runnable, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    protected void showCurrentLocation() {
        ...
        if (location != null) {
            ...
            Toast.makeText(Maps.this, message,
                    Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(Maps.this, "null location",
                    Toast.LENGTH_LONG).show();
        }
    }
   ...
   /* public void start(View v) {
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(Maps.this, message, Toast.LENGTH_LONG).show();
    }
